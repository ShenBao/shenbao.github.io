...
<img src="/img/React/React Dom 01.png" title="React Dom 01.png" width="50%">

本篇主要的讨论范围为 React 与 DOM 相关的处理，包括：
...
本篇之后将会为 TODO 应用添加完整的事件响应，包括新增，删除，标记完成等。
